...
BOARD_BLUEDROID_VENDOR_CONF := device/zte/V55/bluetooth/V55.txt
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR ?= device/zte/V55/bluetooth/include
...
WIFI_DRIVER_FW_PATH_STA := "/system/etc/firmware/fw_bcm4330_abg.bin"
WIFI_DRIVER_FW_PATH_P2P := "/system/etc/firmware/fw_bcm4330_abg.bin"
WIFI_DRIVER_FW_PATH_AP := "/system/etc/firmware/fw_bcm4330_apsta_bg.bin"
